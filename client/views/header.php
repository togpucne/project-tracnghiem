    ...
    <div class="container-fluid p-0">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0)" onclick="requireLogin('index.php?act=dethi')">Đề thi</a>
                            </li>
                            ...
                            <?php if (isset($_SESSION['user'])): ?>
                                <li class="nav-item dropdown ms-3">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">
                                        ...
                                        <li>
                                            <a class="dropdown-item py-2 text-danger" href="index.php?act=dangxuat" onclick="return logoutConfirm()">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4 border-0 shadow-lg">
                    <div class="modal-body text-center p-4 p-md-5">
                        ...
                        <p class="text-muted mb-4">Bạn phải đăng nhập tài khoản mới được tham gia làm bài thi. Vui lòng đăng nhập để tiếp tục.</p>
                        <div class="d-flex flex-column gap-2">
                            <a href="index.php?act=dangnhap" class="btn btn-primary rounded-pill py-2 fw-bold shadow-sm custom-btn"><i class="fa-solid fa-right-to-bracket me-2"></i>Đăng nhập ngay</a>
                            <button type="button" class="btn btn-light rounded-pill py-2 fw-bold text-muted transition-hover" data-bs-dismiss="modal">Để sau</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            function confirmLambai(id, isOngoing) {
                ...
                const msg = isOngoing ? "Bạn có muốn tiếp tục làm bài thi này không?" : "Bạn có chắc chắn muốn bắt đầu làm bài thi này không?";
                if (confirm(msg)) {
