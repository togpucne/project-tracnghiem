    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid #ced4da;">
        <thead>
            <tr style="background: #f8f9fa; border-bottom: 2px solid #adb5bd; text-align: left;">
                ...
                <th style="padding: 15px; border-right: 1px solid #ced4da; text-align: center; width: 120px;">Số bài thi
                </th>
        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #ced4da;" onmouseover="this.style.backgroundColor='#f8f9fa'"
                ...
                <td style="padding: 15px; border-right: 1px solid #ced4da; font-size: 0.9rem; color: #666;">
                    <?php if (!empty($mon['mieuta'])): ?>
                    <div style="max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"
                        title="<?= htmlspecialchars($mon['mieuta']) ?>">
                        <?= htmlspecialchars($mon['mieuta']) ?>
                    </div>
                    <?php else: ?>
                    <span style="color: #ccc; font-style: italic; font-size: 0.85rem;">(Chưa có miêu tả)</span>
                    <?php endif; ?>
                </td>
